...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Chocolate Sprinkles", 0.50, new ArrayList<>(Arrays.asList("dairy")));
        Topping topping2 = new Topping("Rainbow Sprinkles", 0.50, new ArrayList<>(Arrays.asList("sugar, red #5")));
        Topping topping3 = new Topping("Peanuts", 0.75, new ArrayList<>(Arrays.asList("peanuts")));
        Topping topping4 = new Topping("Reeces Pieces", 1.00, new ArrayList<>(Arrays.asList("dairy, peanuts, red #5")));
